...
('Beedrill', '015', 'Poison Bee', 'Beedrill is extremzely territorial. No one should ever approachits nest—this is for their own safety. If angered, they will attackin a furious swarm.', 1.0, 29.5, 3, 5, 2, 2, 3, 4),
...
-- 1º Apresentar todas as colunas
SELECT id, nome, codigo, categoria, altura, peso, hp, ataque, defesa, especial_ataque, especial_defesa, velocidade, descricao
	FROM pokemons;

-- 2º Apresentar o 'ataque', 'defesa', 'especial_ataque', 'especial_defesa'
SELECT id, ataque, especial_ataque, defesa, especial_defesa
	FROM pokemons;

-- 3º Apresentar o 'nome', 'categoria' e ataque ordenado pelo ataque em ordem crescente
